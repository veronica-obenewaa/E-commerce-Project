...
<head>
    ...
    <title>Pharmaceutical Company Registration - Med-ePharma</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                <h1><i class="fas fa-flask-vial"></i> Med-ePharma</h1>
                <p>Pharmaceutical Company Registration</p>
            </div>

            <div class="auth-body">
                <form method="POST" action="../actions/register_customer_action.php" id="companyRegisterForm">
                    <input type="hidden" name="user_role" value="1">

                    <!-- Contact Information Section -->
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                        <div class="form-group">
                            <label for="customer_name"><i class="fas fa-user"></i> Contact Person</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="customer_email" name="customer_email" placeholder="company@email.com" required>
                    ...
                    <div class="form-divider">
                        <div class="form-divider-title"><i class="fas fa-building"></i> Company Details</div>
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                        <div class="form-group">
                            <label for="company_name"><i class="fas fa-hospital"></i> Company Name</label>
                            <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Pharmaceutical company name" required>
                            <div class="invalid-feedback">Enter company name</div>
                        </div>

                        <div class="form-group">
                            <label for="pharmaceutical_registration_number"><i class="fas fa-id-card"></i> Pharma Reg. Number</label>
                            <input type="text" class="form-control" id="pharmaceutical_registration_number" name="pharmaceutical_registration_number" placeholder="Registration number" required>
                            <div class="invalid-feedback">Enter pharmaceutical registration number</div>
                        </div>
                    </div>

                    <button type="submit" id="submitBtn" class="submit-btn">
                        <i class="fas fa-building-check"></i> Complete Registration
                    </button>
                </form>
            </div>
