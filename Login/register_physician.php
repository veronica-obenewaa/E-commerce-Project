            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Physician Registration</h4>
                    ...
                    <div class="card-body">
                        <form method="POST" action="../actions/register_customer_action.php" id="registerForm">
                            ...
                            <div class="mb-3">
                                <label for="medical_specializations" class="form-label">Medical Specializations</label>
                                <select id="medical_specializations" name="medical_specializations[]" class="form-select selectpicker" multiple data-live-search="true">
