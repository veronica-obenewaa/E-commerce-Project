...
<head>
    ...
    <title>Physician Registration - Med-ePharma</title>
    ...
    <style>
        * {
        ...
        body {
            background: linear-gradient(135deg, #e0efe4ff 0%, #14a851 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                <h1><i class="fas fa-stethoscope"></i> Med-ePharma</h1>
                <p>Physician Registration</p>
            </div>

            <div class="auth-body">
                <form method="POST" action="../actions/register_customer_action.php" id="physicianRegisterForm">
                    <input type="hidden" name="user_role" value="3">

                    <!-- Personal Information Section -->
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                        <div class="form-group">
                            <label for="customer_name"><i class="fas fa-user-doctor"></i> Full Name</label>
                            <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Dr. Full Name" required>
                    ...
                    <div class="form-divider">
                        <div class="form-divider-title"><i class="fas fa-briefcase-medical"></i> Professional Details</div>
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                        <div class="form-group">
                            <label for="hospital_name"><i class="fas fa-hospital"></i> Hospital Name</label>
                            <input type="text" class="form-control" id="hospital_name" name="hospital_name" placeholder="Hospital name" required>
                            <div class="invalid-feedback">Enter hospital name</div>
                        </div>

                        <div class="form-group">
                            <label for="hospital_registration_number"><i class="fas fa-id-card"></i> Hospital Reg. Number</label>
                            <input type="text" class="form-control" id="hospital_registration_number" name="hospital_registration_number" placeholder="Registration number" required>
                            <div class="invalid-feedback">Enter hospital registration number</div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="medical_specializations"><i class="fas fa-certificate"></i> Medical Specializations</label>
                        <select class="selectpicker" id="medical_specializations" name="medical_specializations[]" multiple data-live-search="true" required>
                        </select>
            ...
            fetch(window.location.origin + '/~veronica.obenewaa/js/medical_specializations.json')
                ...
                .then(data => {
                    ...
                    data.forEach(specialization => {
                        ...
                        option.setAttribute('data-tokens', specialization.name);
