...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Render product card
        function renderCard(p) {
            ...
            const img = p.product_image ? `${uploadBaseUrl}${p.product_image}`:`${uploadBaseUrl}placeholder.png`;
  ...
  // pagination
        ...
        async function loadSingleProduct() {
            ...
            document.getElementById('prodImage').src = p.product_image ? `${uploadBaseUrl}${p.product_image}`:`${uploadBaseUrl}placeholder.png`;
        }
