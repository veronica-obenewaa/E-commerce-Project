...
define('ZOOM_CLIENT_ID', getenv('ZOOM_CLIENT_ID') ?: 'your_zoom_client_id');
define('ZOOM_CLIENT_SECRET', getenv('ZOOM_CLIENT_SECRET') ?: 'your_zoom_client_secret');
define('ZOOM_ACCOUNT_ID', getenv('ZOOM_ACCOUNT_ID') ?: 'your_zoom_account_id');
